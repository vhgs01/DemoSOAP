package br.com.hugo.victor.demosoap
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btCalcular.setOnClickListener({
            CallWebServices().execute(etNum1.text.toString(), etNum2.text.toString(), spOperacoes.selectedItem.toString())
        })

    }

    inner class CallWebServices : AsyncTask<String, Void, String>() {
        override fun doInBackground(vararg params: String?): String {
            ...
            val operatorInfo = PropertyInfo()
            operatorInfo.name = parametro3
            operatorInfo.value = params[2]
            operatorInfo.type = String::class.java

            soapObject.addProperty(operatorInfo)
